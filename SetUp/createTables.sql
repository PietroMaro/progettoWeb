...
ALTER TABLE segnalazione ADD idChat INT NOT NULL;
ALTER TABLE segnalazione ADD CONSTRAINT  idChatSegnalazione FOREIGN KEY(idChat) REFERENCES Chat(idChat) ON DELETE CASCADE;
