    ...
    return <<<HTML
        <details open class="mb-3 border rounded p-2">
            <summary class="d-flex justify-content-between align-items-center" style="cursor: pointer;">
                ...
                <form action="" method="POST" onsubmit="return confirm('Sei sicuro di voler eliminare questa FAQ?');" style="margin: 0;">
...
function newFaqForm(){
    ...
    <div class="mb-5 p-4 border rounded bg-light shadow-sm">
        <h3 class="h5 mb-3 text-primary"><i class="fas fa-plus-circle me-2"></i>Aggiungi Nuova FAQ</h3>
