<?php
    function ifPostSetSession($postName, $sessionName){
        if(isset($_POST[$postName])){$_SESSION[$sessionName] = $_POST[$postName];}
    }
    ...
    function noChatBlock() {
        return genericErrorBlock("#fff3cd","rgb(0, 0, 0)","Nessuna Chat disponibile","Al momento non hai chat aperte, aspetta di esserre contattato se sei un venditore, o esplora i prodotti se vuoi contattare qualcuno");
    }
    function errorBlock() {
        return genericErrorBlock("#fff3cd","rgb(0, 0, 0)","Nessuna Chat disponibile","Al momento il servizio è temporaneamente non disponibile. Ci scusiamo per il disagio");
    }
